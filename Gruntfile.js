	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/erins-llr.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/erins-llr.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/erins-llr.css',
				dest: '_gh_pages/dist/css/min/erins-llr.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/erins-llr.js',
				dest: '_gh_pages/dist/js/min/erins-llr.min.js'
			}
		},
		watch: {
			css: {
